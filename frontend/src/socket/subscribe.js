...
export const DestinationCount = '/total/destination/1s';
export const DestinationMetric = '/total/destination/metric/1s'
export const DeviceDataIO = '/data/device/IO/1s';
export const DeviceDataProtocol = '/data/device/protocol/1s';
export const DeviceDataDestination = '/data/device/destination/1s';
