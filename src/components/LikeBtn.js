...
export default class LikeBtn extends React.Component {
  ...
  render () {
    ...
    const likeButtonTemplate = (
      <div className={"like-container noselect " + (likeIsOn ? "likeIsOn" : "likeIsOff")}
           onMouseEnter={this.onHover}
           onMouseLeave={this.onLeaveHover}
           onClick={this.props.onClick}>
        <div className="like__icon-ctn unchecked" id="like-cnt">
          <i className="material-icons like__icon">{this.props.toggledLike ? 'favorite' : 'favorite_border'}</i>
