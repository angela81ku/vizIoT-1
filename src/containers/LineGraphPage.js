...
import {OFF_WHITE} from 'VizIoT/styles/base/viz-theme';
    ...
    if (metricRect && graphRect && graphRect.height > 100) {
      ...
      return <StyledLineRenderer>
        <svg width={windowWidth} height={windowHeight}
             style={{top: metricRect.top, left: metricRect.left, position: 'absolute'}}>
          <line strokeWidth="2px" stroke={color} x1={metricx1} y1={metricy1} x2={metricx2} y2={metricy2}
                id="metric-vert"/>
          <line strokeWidth="2px" stroke={color} x1={horizontalx1} y1={horizontaly1} x2={horiztonalx2} y2={horizontaly2}
                id="metric-horiz"/>
